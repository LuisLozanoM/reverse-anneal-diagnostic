...
A single SDK default (auto-scale) shifts $\mathcal{M}$ by $\approx 0.98$ on the same embedded problem in the crossover region, making submission metadata part of the measurement itself.
...
\caption{\textbf{Classical dynamics retain full memory where the QPU relaxes; small-system ED is consistent with transverse-field-driven relaxation.}
